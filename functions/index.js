...
const { isFiniteNum, numberOrNull, haversineKm, bucketForServer } = require("./lib/geo");
const { getKitchenQueueCount, computePrepMin, readCapacityConfig, computeKitchenLoad } = require("./lib/kitchen");
const { allowedUnitPriceCents, priceCartItems, computeAuthoritativeOrder, refundOrphanChargeBestEffort } = require("./lib/pricing");
const { generateSecretCode, chunkArray } = require("./lib/util");
const { applyRefundToOrder } = require("./lib/refund");

// ── Domaines extraits (barrel) — Phase 2 : functions regroupées par domaine ──
// Chaque domaine exporte ses CloudFunctions ; Object.assign les ajoute à `exports`
// sans écraser les functions encore inline (migration incrémentale, noms identiques).
Object.assign(exports, require("./domains/media"));
Object.assign(exports, require("./domains/football"));

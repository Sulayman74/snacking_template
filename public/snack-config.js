...
features: {
    ...
    enableOnlineOrder: data.enableOnlineOrder !== undefined ? data.enableOnlineOrder : true,
    enableDelivery: data.enableDelivery !== undefined ? data.enableDelivery : false,
    enableClickAndCollect: data.enableClickAndCollect !== undefined ? data.enableClickAndCollect : true,
